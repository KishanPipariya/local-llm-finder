...
export function Results({ result }: { result: RecommendationResult }) {
  return <section className="results" id="results" aria-labelledby="results-title">
    ...
    <p className="catalogue-scope">Catalogue scope: this is a live, limited set of verified native Ollama pulls plus Hugging Face GGUF and MLX artifacts, ranked with metadata-derived fit estimates. It does not verify model quality or real-world performance.</p>
